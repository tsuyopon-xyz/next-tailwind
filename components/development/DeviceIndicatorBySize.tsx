...
const DeviceIndicatorBySize: React.FC = () => {
  return (
    <div className="fixed left-0 bottom-0 m-8 p-3 text-xs text-white h-20 w-20 rounded-full flex items-center justify-center bg-gray-700 tablet:bg-pink-500 laptop:bg-yellow-500 desktop:bg-green-500">
